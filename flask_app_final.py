...
if __name__ == "__main__":
    ...
    init_database()
    print(f"🚀 NLP Query Engine starting on http://localhost:{port}")
    ...
    print(f'   curl -X POST "http://localhost:{port}/api/query" -H "Content-Type: application/json" -d \'{{"query": "Average salary by department"}}\'')
    print(f'   curl -X POST "http://localhost:{port}/api/query" -H "Content-Type: application/json" -d \'{{"query": "Show Python developers"}}\'')
